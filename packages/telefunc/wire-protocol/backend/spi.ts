...
//  semantic  RoomOrder (monotonic seq)         ONE channel        participant text + Room.announce
//  control   ControlSeq (per-room counter)     control channel    presence/lifecycle; always observed
