...
// the body's first await, while the request context still exists; the sweep that follows serialization
 ...
 *  create on the context, and register the finally-sweep so any read token minted but never activated
