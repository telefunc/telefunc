...
// server extension whose `setup` receives the host toolkit — a `Live` producer (`createLive`) and
// per-request cleanup (`onRequestCleanup`) — and uses those in its read-capture engine. Registration is
