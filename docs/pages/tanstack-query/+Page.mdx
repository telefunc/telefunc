...
> **First-party integration.** Telefunc's extension API is currently unstable and intended for first-party integrations only. It will be opened up and documented for third-party integrations once it stabilizes.
