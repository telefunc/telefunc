...
> **How does it work?** Under the hood, the `global:` key is sent to the server and then <Link href="/channel#broadcast">broadcast</Link> to every client that has a matching query key. Learn more at <Link href="#how-it-works" />.
