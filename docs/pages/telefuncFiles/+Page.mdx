...
If you don't use Telefunc's transformer on your server-side (see <Link href="/how-it-works" />) then you need to provide the list of your `.telefunc.js` files to Telefunc.
