...
> Applies to all <Link href="/streaming">streaming and real-time</Link> values — `AsyncGenerator`, `ReadableStream`, files, `Channel`, `BroadcastChannel` — they all close the same way.
