...
Manually close a <Link href="/stream">Telefunc stream</Link>.

You usually don't need to close streams manually, see:
- <Link href="#when-to-close" />

The `close()` function is one way amongst other to manually close, see:
- <Link href="#how-to-close" />
