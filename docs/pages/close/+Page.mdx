...
Returning `clear` is optional: if you don't, the stream still closes itself automatically after React unmounts the component, once the garbage collector clears the stream object.
