...
Telefunc `duplicate()`s the client internally for its own connections — your instance is never mutated or disconnected. You can continue to use it alongside Telefunc without interference.
