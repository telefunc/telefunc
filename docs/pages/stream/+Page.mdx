...
> The word *stream* denotes — broadly speaking, [as Wikipedia defines it](https://en.wikipedia.org/wiki/Stream_(computing)) — not just a `ReadableStream` but any sequence of data made available over time.
