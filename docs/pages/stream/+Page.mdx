...
> It's a good fit because a generator closes itself when it completes. (Other streaming primitives like <Link href="#callback">callbacks</Link> don't have such a completion signal.)
>
