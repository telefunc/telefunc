...
> - `throw Abort()` during a stream is relayed <Link href="/error-handling#error-flows">as an expected error</Link>
> - Any other thrown error is treated <Link href="/error-handling#error-flows">as a bug</Link>
