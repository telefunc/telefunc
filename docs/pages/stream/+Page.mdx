...
> Broadly speaking (and [as Wikipedia defines it](https://en.wikipedia.org/wiki/Stream_(computing))), the word *stream* denotes not only a `ReadableStream`, but any sequence of data made available over time.
