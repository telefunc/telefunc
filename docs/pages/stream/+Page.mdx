...
You can cancel a stream at anytime with <Link href="/close">`close()` (and other methods)</Link> — you can then use the <Link href="/onClose">`onClose()` hook</Link> to clear resources.
