...
✅ **Backpressure** — <Link href="/channel#backpressure">automatic backpressure</Link> when network is the bottleneck.  
✅ **Reconnection** — <Link href="/channel#reconnection">automatic recover</Link> from network issues.  
