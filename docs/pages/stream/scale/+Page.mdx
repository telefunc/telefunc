...
If you use <Link href="/stream">Telefunc's streaming capabilities</Link>, then scaling Telefunc horizontally (multiple Node instances, multiple containers, multiple machines) adds two requirements:
