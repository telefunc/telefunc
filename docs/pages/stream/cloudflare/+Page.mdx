...
>
> The session Durable Object and KV bindings are required whenever you use `telefunc/cloudflare`; Rooms additionally require the SQLite `TelefuncRoomDurableObject` binding shown above. If your app doesn't use `Channel`, `Broadcast`, or `Room`, you can skip these bindings and use <Link href="/serve"><code>serve()</code></Link> instead.
>
