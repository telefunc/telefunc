...
| Presence lag | A new subscriber may miss publishes until the key's authority sees its KV presence record; Workers KV can take up to 60 seconds to propagate across locations. |
