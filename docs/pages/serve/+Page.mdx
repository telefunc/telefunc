...
You can pass the Node.js [`req` readable stream](https://nodejs.org/api/http.html#class-httpincomingmessage), and apply the result to the Node.js [`res` object](https://nodejs.org/api/http.html#class-httpserverresponse).

For example when using [Express](https://expressjs.com):
