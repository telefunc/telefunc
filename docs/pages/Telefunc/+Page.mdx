...
With the Node.js [`req` object](https://nodejs.org/api/http.html#class-httpincomingmessage) and [`res` object](https://nodejs.org/api/http.html#class-httpserverresponse) (e.g. Express.js):
