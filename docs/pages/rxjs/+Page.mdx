...
> **Automatic type runtime validation**: all value sent from the client to the server are validated <Link href="/shield#typescript-automatic">against TypeScript types</Link> at runtime (no need for Zod).
