...
The `@telefunc/rxjs` integration lets you pass [RxJS](https://rxjs.dev) `Observable` and `Subject` instances directly between client and server, in both directions and with all operators.
