...
The `@telefunc/rxjs` integration lets you pass the RxJS's `Observable` and `Subject` transparently between client and server — both directions. All RxJS operators work out of the box.
