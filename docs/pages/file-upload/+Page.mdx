...
File bytes flow directly from the HTTP stream to your code with zero internal buffering: memory stays constant regardless of file size. Two trade-offs follow:
